...
jQuery(document).ready(function(jQuery){
  ...
  jQuery('.callBack__link, .callBack__link a').magnificPopup({
    items: {
      src: '#cf7__callBack',
      type:'inline',
      midClick: true
  ...
  jQuery('.service__popup, .service__popup a').magnificPopup({
    items: {
      src: '#service__popup',
      type:'inline',
      midClick: true
  ...
  jQuery('.priceTable__orderLink').magnificPopup({
    type:'inline',
    midClick: true
  });

  jQuery('.callBack__button a').magnificPopup({
    type:'inline',
    midClick: true
  });

  //callBackHunter
  jQuery('.pulse-button').magnificPopup({
    type:'inline',
    midClick: true
  });

  jQuery('.cbh-popup__callBack').magnificPopup({
    type:'inline',
    midClick: true
  });

  //Check 1 row Form f1034
  jQuery('#cnf7-1034 .f1034__show-contacts').click( function(){
      var grazhdanstvo = jQuery('#cnf7-1034 [name="grazhdanstvo"]').val();
      var visetype = jQuery('#cnf7-1034 [name="visetype"]').val();
      var kratnost = jQuery('#cnf7-1034 [name="kratnost"]').val();
      var srokDeystviya = jQuery('#cnf7-1034 [name="srokDeystviya"]').val();
      console.log(grazhdanstvo);
      console.log(visetype);
      console.log(kratnost);
      console.log(srokDeystviya);
      if ( (grazhdanstvo == 'Выберите') || (visetype == '---') || (kratnost == '---') || (srokDeystviya == '---') ) {
          alert ('Выберите значения из всех полей'); 
      } else {
          jQuery(this).hide();
          jQuery('.f1034__contacts').slideDown();
      }
      return false;
  });

  //Check Form f1034
  jQuery('#cnf7-1034 .wpcf7-submit').click( function(){
      var phone = jQuery('#cnf7-1034 input[type="tel"]').val();
      var email = jQuery('#cnf7-1034 input[type="email"]').val();
      if( phone == '' && email == '') {
          alert('Вы не ввели почту или телефон!');
          return false;
      } else {
          return true;
      }
  ...
  //Check 1 row Form f1038
  jQuery('#cnf7-1038 .f1034__show-contacts').click( function(){
      var grazhdanstvo = jQuery('#cnf7-1038 [name="grazhdanstvo"]').val();
      var specialty = jQuery('#cnf7-1038 [name="specialty"]').val();
      var region = jQuery('#cnf7-1038 [name="region"]').val();
      var kolichestvo_chelovek = jQuery('#cnf7-1038 [name="kolichestvo_chelovek"]').val();
      if ( (grazhdanstvo == 'Выберите') || (specialty == '---') || (region == '---') ) {
          alert ('Выберите значения из всех полей'); 
      } else {
          jQuery(this).hide();
          jQuery('.f1034__contacts').slideDown();
  ...
  // max 3 simbols
  var maxLen = 3;
  jQuery('#cnf7-1038 [name="kolichestvo_chelovek"]').keyup( function(){
  ...
  //Check Form f1038
  jQuery('#cnf7-1038 .wpcf7-submit').click( function(){
      var phone = jQuery('#cnf7-1038 input[type="tel"]').val();
      var email = jQuery('#cnf7-1038 input[type="email"]').val();
      if( phone == '' && email == '') {
          alert('Вы не ввели почту или телефон!');
          return false;
      } else {
  ...
  //Страница оплаты	
  jQuery('.pay-yandex').click( function(){
    jQuery('.fondy').hide();
    jQuery('.money-yandex').show();
  });

  jQuery('.pay-fondy').click( function(){
    jQuery('.fondy').show();
    jQuery('.money-yandex').hide();
  });

  jQuery('.rab__title').matchHeight();
  jQuery('.rab__content').matchHeight();

  // jQuery('.ap-price__desc').matchHeight();
...
/* vprice tabs */
jQuery("#vprice__more_1").on('click', function() {
  jQuery("#vprice__more_2, #vprice__more_3").removeClass('vprice__more_active');
  jQuery(this).addClass('vprice__more_active');
  jQuery(".vprice__tab_2, .vprice__tab_3").hide();
  jQuery(".vprice__tab_1").slideDown();
  return false;
});
jQuery("#vprice__more_2").on('click', function() {
  jQuery("#vprice__more_1, #vprice__more_3").removeClass('vprice__more_active');
  jQuery(this).addClass('vprice__more_active');
  jQuery(".vprice__tab_1, .vprice__tab_3").hide();
  jQuery(".vprice__tab_2").slideDown();
  return false;
});
jQuery("#vprice__more_3").on('click', function() {
  jQuery("#vprice__more_1, #vprice__more_2").removeClass('vprice__more_active');
  jQuery(this).addClass('vprice__more_active');
  jQuery(".vprice__tab_1, .vprice__tab_2").hide();
  jQuery(".vprice__tab_3").slideDown();
  return false;
});

jQuery(".vprice__tab-close").on('click', function() {
  jQuery(this).parent().slideUp();
  jQuery("#vprice__more_1, #vprice__more_2, #vprice__more_3").removeClass('vprice__more_active');
  return false;
});
